...
//                        ", DBConnection.con);
        ...
        public static void GetPassos(TestCase testCase) 
        {
                ...
                OracleCommand sql_cmd = new OracleCommand(@"
                SELECT * FROM PassoDoTeste WHERE COD_TESTCASE=:COD_TESTCASE ORDER BY NUM_ORDEM_SEQ", DBConnection.con);
        ...
        public static void Deletar(TestCase testCase)
        {
                ...
                sql_cmd = new OracleCommand(@"DELETE FROM TESTCASE WHERE COD_TESTCASE = :COD_TESTCASE
                        ", DBConnection.con);
        ...
        public static List<TestCase> GetAllFromSistema(Sistema sistema)
        {
            ...
            List<TestCase> testCases = new List<TestCase>();
                ...
                try
                {
                    ...
                    //Carrega Registros
                    OracleCommand sql_cmd = new OracleCommand("SELECT * FROM TESTCASE where COD_SISTEMA = :COD_SISTEMA", DBConnection.con);
        ...
        public static TestCase GetTestCaseById(int id)
        {
            ...
            sql_cmd = new OracleCommand(@"SELECT * FROM TESTCASE WHERE COD_TESTCASE = :COD_TESTCASE
                        ", DBConnection.con);
        ...
        public static void CopyTestCase(string nomeCtf, TestCase selectedCase)
        {
            try
            {
                ...
                OracleCommand sql_cmd3 = new OracleCommand(@"SELECT * FROM passodoteste WHERE cod_testcase = :cod_testcase ", DBConnection.con);
                ...
                foreach (var passo in idPassos)
                {
                    ...
                    OracleCommand sql_cmd2 = new OracleCommand(@"
