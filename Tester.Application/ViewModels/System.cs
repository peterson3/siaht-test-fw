...
namespace UI_test_player_TD.Model
{
    public class Sistema
    {
        ...
        private ObservableCollection<Screen> _telas { get; set; }
        public ObservableCollection<Screen> telas {
            get 
            {
                if (_telas == null)
                {
                    _telas = new ObservableCollection<Screen>(ScreenRepository.getAllTelas(this));
                }
                return _telas;
            }
            set 
