...
using Tester.Domain.Enums;
using Tester.CrossCutting;
...
namespace UI_test_player_TD.Model
{
    public class TestCase : INotifyPropertyChanged
    {
        ...
        public void exec(int sleepTime, int browserCod)
        {
            ...
            switch (browserCod)
            {
                case (int)BrowserTypes.IE_BROWSER:
                    Settings.BrowserDesc = "Internet Explorer";
                    break;
                case (int)BrowserTypes.CHROME_BROWSER:
                    Settings.BrowserDesc = "Google Chrome";
                    break;
                case (int)BrowserTypes.FIREFOX_BROWSER:
                    Settings.BrowserDesc = "Mozilla Firefox";
                    break;
                case (int)BrowserTypes.SAFARI_BROWSER:
                    Settings.BrowserDesc = "Safari";
                    break;
                case (int)BrowserTypes.EDGE_BROWSER:
                    Settings.BrowserDesc = "Microsoft Edge";
                    break;
                case (int)BrowserTypes.OPERA_BROWSER:
