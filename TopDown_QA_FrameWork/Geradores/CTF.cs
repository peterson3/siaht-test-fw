...
namespace TopDown_QA_FrameWork.Geradores
{
    public static class CTF
    {
        ...
        {
            CTF.imgsQtd = 0;
            CTF.passo = 0; //Inicial passo =1
            CTF.semiPasso = 1;
            CTF.currentFile = nome;
            CTF.currentRow = 12;    //Initial Row = 12
        ...
        public static void registrarTela()
        {
            ...
            //resultado obtido
            sheet1.GetRow(currentRow).GetCell(0).SetCellValue("Tela " + CTF.imgsQtd.ToString("00"));
            //sheet1.GetRow(6).GetCell(6).CellStyle = style;
            //sheet1.GetRow(6).GetCell(6).SetCellValue("Aprovado");
