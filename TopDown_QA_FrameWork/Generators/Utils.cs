...
namespace TopDown_QA_FrameWork.Geradores
{
    public static class Utils
    {
        ...
        public static string geraCep()
        {
            ...
            Driver.openAuxDriver("http://4devs.com.br/gerador_de_cep");

            
            
            //Localizar Botão Gera CEP
            By procura_btnGeraCEP = By.Id("btn_gerar_cep");
            Driver.auxWait.Until(ExpectedConditions.ElementToBeClickable((procura_btnGeraCEP)));
            IWebElement btnCEPElementInput = Driver.auxWebDriver.FindElement(procura_btnGeraCEP);
            ...
            Driver.auxWait.Until(ExpectedConditions.ElementToBeClickable(procura_CEP_field));
            IWebElement cepField = Driver.auxWebDriver.FindElement(procura_CEP_field);
